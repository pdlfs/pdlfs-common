...
// The raw version of the same call.
// REQUIRES: the result must be able to hold the entire contents.
extern Slice AppendInternalKeyPtr(char* result, const ParsedInternalKey& key);
